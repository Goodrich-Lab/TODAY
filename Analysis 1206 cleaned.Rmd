...
fit <- coxph(Surv(yrstohyp2, hyp) ~ hb_a1c + case1_control0 + sex + agebase + serum_creat, data = df)
...
mediation_result <- CMAverse::cmest(data1, 
                          ...
                          yreg = "coxph", 
                          model = "gformula",
                          astar = quantile(data$hb_a1c, probs = 0.25),
                          a = quantile(data$hb_a1c, probs = 0.75),
                          mval = list(0), 
