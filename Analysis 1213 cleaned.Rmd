...
# Create categorical PFAS which are needed for the score
...
plot(grm(burden_score_pfas), type = "IIC",legend = TRUE, 
...
# Make Plot 
ggplot(curve, aes(x = Years, y = surv, color = variable)) + 
  geom_step(size = 1) + 
  scale_y_continuous(limits =  c(0, 1)) + 
  ylab("Hyperfiltration Rate") + 
